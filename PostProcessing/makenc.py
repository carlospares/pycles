...
path = '/cluster/scratch/carlospa/post_bomexfull/'
...
outfile = '/cluster/scratch/carlospa/pv_bomexfull/to_paraview.nc'
...
units = ['m/s', 'm/s', 'm/s', 'kg/kg', 'kg/kg', 'K']
...
x = np.arange(v.shape[0]) * 25.0

y = np.arange(v.shape[1]) * 25.0

z = np.arange(v.shape[2]) * 10.0
