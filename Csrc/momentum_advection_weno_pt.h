            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const double vel_adv = vel_advected[ijk + sp1_ed] + vel_advected[ijk];
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno3(vel_advected[ijk + sm1_ed]*vel_advected[ijk + sm1_ed]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep]);
                        }  else  {
                            flux[ijk] = interp_weno3(vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k]);
                        }
                    } // k loop
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const double vel_adv = vel_advecting_rec[ijk + sp1_ing] + vel_advecting_rec[ijk];
                        
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno3(vel_advected[ijk + sm1_ing]*vel_advecting_rec[ijk + sm1_ing]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep]);
                        }  else  {
                            flux[ijk] = interp_weno3(vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k]);
...
void hiweno_fifth_order_m_pt(struct DimStruct *dims, double* restrict rho0, double* restrict rho0_half,
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const double vel_adv = vel_advected[ijk + sp1_ed] + vel_advected[ijk];
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno5(vel_advected[ijk + sm2_ed]*vel_advected[ijk + sm2_ed]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ed]*vel_advected[ijk + sm1_ed]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno5(vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sm1_ed]*vel_advected[ijk + sm1_ed]*rho0adj[k - kstep]);
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno5(vel_advected[ijk + sm2_ing]*vel_advecting_rec[ijk + sm2_ing]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ing]*vel_advecting_rec[ijk + sm1_ing]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno5(vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sm1_ing]*vel_advecting_rec[ijk + sm1_ing]*rho0adj[k - kstep]);
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const double vel_adv = vel_advected[ijk + sp1_ed] + vel_advected[ijk];
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno7(vel_advected[ijk + sm3_ed]*vel_advected[ijk + sm3_ed]*rho0adj[k - 3*kstep],
                                                     vel_advected[ijk + sm2_ed]*vel_advected[ijk + sm2_ed]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ed]*vel_advected[ijk + sm1_ed]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno7(vel_advected[ijk + sp4_ed]*vel_advected[ijk + sp4_ed]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno7(vel_advected[ijk + sm3_ing]*vel_advecting_rec[ijk + sm3_ing]*rho0adj[k - 3*kstep],
                                                     vel_advected[ijk + sm2_ing]*vel_advecting_rec[ijk + sm2_ing]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ing]*vel_advecting_rec[ijk + sm1_ing]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno7(vel_advected[ijk + sp4_ing]*vel_advecting_rec[ijk + sp4_ing]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
    ...
    double* restrict tendency, ssize_t d_advected, ssize_t d_advecting){
        ...
        const ssize_t sp3_ed = 3*sp1_ed ;
        const ssize_t sp4_ed = 4*sp1_ed ;
        const ssize_t sp5_ed = 5*sp1_ed ;
        const ssize_t sm1_ed = -sp1_ed ;
        const ssize_t sm2_ed = -2*sp1_ed ;
        const ssize_t sm3_ed = -3*sp1_ed ;
        const ssize_t sm4_ed = -4*sp1_ed ;

        const ssize_t sp1_ing = stencil[d_advected];
        const ssize_t sp2_ing = 2*sp1_ing ;
        const ssize_t sp3_ing = 3*sp1_ing ;
        const ssize_t sp4_ing = 4*sp1_ing ;
        const ssize_t sp5_ing = 5*sp1_ing ;
        const ssize_t sm1_ing = -sp1_ing ;
        const ssize_t sm2_ing = -2*sp1_ing ;
        const ssize_t sm3_ing = -3*sp1_ing ;
        const ssize_t sm4_ing = -4*sp1_ing;
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const double vel_adv = vel_advected[ijk + sp1_ed] + vel_advected[ijk];
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno9(vel_advected[ijk + sm4_ed]*vel_advected[ijk + sm4_ed]*rho0adj[k - 4*kstep],
                                                     vel_advected[ijk + sm3_ed]*vel_advected[ijk + sm3_ed]*rho0adj[k - 3*kstep],
                                                     vel_advected[ijk + sm2_ed]*vel_advected[ijk + sm2_ed]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ed]*vel_advected[ijk + sm1_ed]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp4_ed]*vel_advected[ijk + sp4_ed]*rho0adj[k + 4*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno9(vel_advected[ijk + sp5_ed]*vel_advected[ijk + sp5_ed]*rho0adj[k + 5*kstep],
                                                     vel_advected[ijk + sp4_ed]*vel_advected[ijk + sp4_ed]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ed]*vel_advected[ijk + sp1_ed]*rho0adj[k + kstep],
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno9(vel_advected[ijk + sm4_ing]*vel_advecting_rec[ijk + sm4_ing]*rho0adj[k - 4*kstep],
                                                     vel_advected[ijk + sm3_ing]*vel_advecting_rec[ijk + sm3_ing]*rho0adj[k - 3*kstep],
                                                     vel_advected[ijk + sm2_ing]*vel_advecting_rec[ijk + sm2_ing]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ing]*vel_advecting_rec[ijk + sm1_ing]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp4_ing]*vel_advecting_rec[ijk + sp4_ing]*rho0adj[k + 4*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno9(vel_advected[ijk + sp5_ing]*vel_advecting_rec[ijk + sp5_ing]*rho0adj[k + 5*kstep],
                                                     vel_advected[ijk + sp4_ing]*vel_advecting_rec[ijk + sp4_ing]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
                                                     vel_advected[ijk + sp1_ing]*vel_advecting_rec[ijk + sp1_ing]*rho0adj[k + kstep],
    ...
    double* restrict tendency, ssize_t d_advected, ssize_t d_advecting){
        ...
        const ssize_t sp4_ed = 4*sp1_ed ;
        const ssize_t sp5_ed = 5*sp1_ed ;
        const ssize_t sp6_ed = 6*sp1_ed ;
        const ssize_t sm1_ed = -sp1_ed ;
        const ssize_t sm2_ed = -2*sp1_ed ;
        const ssize_t sm3_ed = -3*sp1_ed ;
        const ssize_t sm4_ed = -4*sp1_ed ;
        const ssize_t sm5_ed = -5*sp1_ed ;
        ...
        const ssize_t sp4_ing = 4*sp1_ing ;
        const ssize_t sp5_ing = 5*sp1_ing ;
        const ssize_t sp6_ing = 6*sp1_ing ;
        const ssize_t sm1_ing = -sp1_ing ;
        const ssize_t sm2_ing = -2*sp1_ing ;
        const ssize_t sm3_ing = -3*sp1_ing ;
        const ssize_t sm4_ing = -4*sp1_ing ;
        const ssize_t sm5_ing = -5*sp1_ing ;
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const double vel_adv = vel_advected[ijk + sp1_ed] + vel_advected[ijk];
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno11(vel_advected[ijk + sm5_ed]*vel_advected[ijk + sm5_ed]*rho0adj[k - 5*kstep],
                                                     vel_advected[ijk + sm4_ed]*vel_advected[ijk + sm4_ed]*rho0adj[k - 4*kstep],
                                                     vel_advected[ijk + sm3_ed]*vel_advected[ijk + sm3_ed]*rho0adj[k - 3*kstep],
                                                     vel_advected[ijk + sm2_ed]*vel_advected[ijk + sm2_ed]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ed]*vel_advected[ijk + sm1_ed]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advected[ijk]*rho0adj[k],
                                                     ...
                                                     vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp4_ed]*vel_advected[ijk + sp4_ed]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp5_ed]*vel_advected[ijk + sp5_ed]*rho0adj[k + 5*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno11(vel_advected[ijk + sp6_ed]*vel_advected[ijk + sp6_ed]*rho0adj[k + 6*kstep],
                                                     vel_advected[ijk + sp5_ed]*vel_advected[ijk + sp5_ed]*rho0adj[k + 5*kstep],
                                                     vel_advected[ijk + sp4_ed]*vel_advected[ijk + sp4_ed]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp3_ed]*vel_advected[ijk + sp3_ed]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ed]*vel_advected[ijk + sp2_ed]*rho0adj[k + 2*kstep],
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        if(vel_adv >= 0) {
                            flux[ijk] = interp_weno11(vel_advected[ijk + sm5_ing]*vel_advecting_rec[ijk + sm5_ing]*rho0adj[k - 5*kstep],
                                                     vel_advected[ijk + sm4_ing]*vel_advecting_rec[ijk + sm4_ing]*rho0adj[k - 4*kstep],
                                                     vel_advected[ijk + sm3_ing]*vel_advecting_rec[ijk + sm3_ing]*rho0adj[k - 3*kstep],
                                                     vel_advected[ijk + sm2_ing]*vel_advecting_rec[ijk + sm2_ing]*rho0adj[k - 2*kstep],
                                                     vel_advected[ijk + sm1_ing]*vel_advecting_rec[ijk + sm1_ing]*rho0adj[k - kstep],
                                                     vel_advected[ijk]*vel_advecting_rec[ijk]*rho0adj[k],
                                                     ...
                                                     vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp4_ing]*vel_advecting_rec[ijk + sp4_ing]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp5_ing]*vel_advecting_rec[ijk + sp5_ing]*rho0adj[k + 5*kstep]);
                        }  else  {
                            flux[ijk] = interp_weno11(vel_advected[ijk + sp6_ing]*vel_advecting_rec[ijk + sp6_ing]*rho0adj[k + 6*kstep],
                                                     vel_advected[ijk + sp5_ing]*vel_advecting_rec[ijk + sp5_ing]*rho0adj[k + 5*kstep],
                                                     vel_advected[ijk + sp4_ing]*vel_advecting_rec[ijk + sp4_ing]*rho0adj[k + 4*kstep],
                                                     vel_advected[ijk + sp3_ing]*vel_advecting_rec[ijk + sp3_ing]*rho0adj[k + 3*kstep],
                                                     vel_advected[ijk + sp2_ing]*vel_advecting_rec[ijk + sp2_ing]*rho0adj[k + 2*kstep],
