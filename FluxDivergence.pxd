...
cdef extern from 'flux_divergence.h':
    void scalar_flux_divergence_wrapper(Grid.DimStruct *dims, double *alpha0, double *alpha0_half,
                                double* velocity, double *flux, double *tendency, double dx, ssize_t d, int isNonConserv) nogil
